...
function Navbar() {
  ...
  return (
    <nav id="navbar">
      <div className="logo">
        {/* Removed RGB animation from here */}
        <div className="title">
          <h2 className="letter" style={{ color: "yellow" }}>
            Port
          </h2>
      ...
      <div className="nav-links hide-on-small">
        <Link to="/" id="section-link">
          Home
        </Link>
        <Link onClick={scrollToAbout} to="/" id="about-link">
          About
        </Link>
        <Link onClick={scrollToService} to="/">
          Services
        </Link>
        <Link onClick={scrollToFuture} to="/">
          Future
        </Link>
        <Link to="/">Blog</Link>
        ...
        >
          ...
          <div class="offcanvas-body">
            ...
            <div className="nav-mob" id="navbarSupportedContent">
              ...
              <Link data-bs-dismiss="offcanvas" to="#nav" className="BlogNav">
                Blog
              </Link>
              <Link
